        ...
        <table className="w-full">
          <thead>
            <tr className="border-b border-gray-700">
              ...
              <th className="text-left py-3 px-4 text-gray-400 font-semibold">Ticker</th>
              <th className="text-right py-3 px-4 text-gray-400 font-semibold">Shares</th>
            ...
            {trades.map((trade, i) => {
              ...
              return (
                <tr key={i} className="border-b border-gray-700 hover:bg-gray-700 transition-colors">
                  ...
                  <td className="py-3 px-4 font-bold text-blue-400">{trade.ticker}</td>
